...
$pr = new Product;
$prods = $pr->selectAllWithCats("products.id AS prodId, products.name AS prodName, price, pieces_no, img, products.created_at AS prodCreatedAt, cats.name AS catName");
?>
